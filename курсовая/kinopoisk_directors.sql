...
CREATE TABLE `directors` (
  ...
  CONSTRAINT `directors_ibfk_2` FOREIGN KEY (`series_id`) REFERENCES `series` (`id`),
  CONSTRAINT `directors_ibfk_3` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Режиссер';
