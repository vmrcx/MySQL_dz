...
CREATE TABLE `actors` (
  ...
  `career` varchar(100) DEFAULT NULL COMMENT 'Деятельность',
  ...
  CONSTRAINT `actors_ibfk_1` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`),
  CONSTRAINT `actors_ibfk_2` FOREIGN KEY (`series_id`) REFERENCES `series` (`id`),
  CONSTRAINT `actors_ibfk_3` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Участники';
